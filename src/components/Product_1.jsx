...
function Product_1() {
    return (
        <section className='h-[50vh] bg-no-repeat' style={{ backgroundImage: `url(${Chicken})` }}>
            <div className='flex justify-center items-center h-full'>
                <div className='text-center'>
                    ...
                    <p className='max-w-[700px] mt-[4rem] text-white text-lg'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
