    ...
    return (
        <section>
            <div className="h-[80vh] flex justify-center items-center relative">
                ...
                <img src={Vector} className='absolute -bottom-[12rem] left-[3rem]' />

                <div className="flex justify-between">
                    <h2 className='text-4xl font-bold'>OUR <br /> <span className='text-7xl font-bold text-[#2ea2d0]'>Story</span></h2>
                    <p className='max-w-[380px] ml-[5rem] text-lg'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum su spendisse ultrices gravida. Risus commodo viverra maec  enas accumsan lacus vel facilisis. <br />
                    <span className='mt-[5rem]'><a href="#" className='text-[#2ea2d0]'>Read more</a></span></p>
